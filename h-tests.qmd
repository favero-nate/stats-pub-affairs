...
We already saw how to evaluate this when the qualitative variable is binary, but what about when it is not? Consider the qualitative variable `region`, which divides the country into four different parts (using U.S. Census Bureau regions).[^h-tests-3]
