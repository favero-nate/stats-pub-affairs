...
-   Chapters are relatively short (usually less than 5000 words), allowing for quick reading and making clear the most essential material for students to master on each topic. Given the broad audience of this text, it may be helpful to read these short chapters alongside applied examples from the field(s) most relevant to students' program of study. Chapter appendices sometimes provide additional content that may be important for more technically-oriented versions of an intro course.
...
This digital book is meant to be a free resource, and this version is licensed under [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/). This book was made using [Quarto](https://quarto.org/) and is hosted using [GitHub Pages](https://pages.github.com/).

There are still formatting inconsistencies, and this is still a work in progress. If you find errors, feel free to reach out (find updated contact info here: <https://nathanfavero.com>) so I can correct them for the next version I publish.

## Acknowledgements

Portions of this book (and most of the original version) are adapted from the public domain resource *Online Statistics Education: A Multimedia Course of Study* (<https://onlinestatbook.com> Project Leader: David M. Lane, Rice University). A huge thanks to David Lane and his colleagues at Rice University for their creation of this wonderful resource. I use footnotes throughout to indicate when specific sections are adapted from Lane and colleagues. Currently, @sec-describing-one-variable and @sec-sampling-distributions are mostly derived from this public domain resource.
