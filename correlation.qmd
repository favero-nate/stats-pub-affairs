...
\[***Working draft notes for instructors**: I am hoping to replace the linear regression example so that it comes from the chapter case study dataset. If you were looking at this in June, note that I have now (as of July 1) move the section on variable transformations to the middle of this chapter (it was previously in Ch. 3).*\]
...
Data Excerpt
+--------+-------------+-----------+--------+-------------+---------+-------------+
| id     | country     | stability | urban  | z_stability | z_urban | z_stability |
|        |             |           |        |             |         |  × z_urban  |
+========+=============+===========+========+=============+=========+=============+
