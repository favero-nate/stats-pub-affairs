...
@eq-ExtRegNonBin and @eq-ExtRegFemNonBin indicate equivalent predictions for extraversion based on gender; they just offer this information in two different formats. @eq-ExtRegFemNonBin might be a bit trickier to understand for now, but it will become very useful in the future.
