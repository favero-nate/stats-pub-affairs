...
Suppose you have a friend who has been trying to use social media to build and strengthen their professional network. When this friend finds out that you're studying statistics, they start coming to you with questions about what they can learn from the engagement data from their social media account.

The Overview Table below shows some basic statistics for your friend's profile while the Engagement Comparison provides a comparison of the number of "likes" for posts of different lengths. (Note that while I am describing a hypothetical friend to make this example more vivid, the underlying data is an unmodified copy of a real user's data.)

```         
Overview Table

| # of Posts | Average Length | Average Likes | Includes Image |
|------------|----------------|---------------|----------------|
| 70         | 164            | 6.5           | 23%            |

Engagement Comparison

|               | Short Posts | Medium Posts | Long Posts |
|---------------|-------------|--------------|------------|
| Average Likes | 2.7         | 1.9          | 13.0       |
```
