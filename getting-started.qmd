...
\[Notes for working draft: Examples throughout the chapter should be revised to make wider use of the social media dataset from the initial example. I can maybe swap this in wherever I currently use the country-level dataset.\]
