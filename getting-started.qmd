...
In this chapter, we'll be introduced to several different datasets and will start learning some fundamentals for describing and exploring data. First, we'll learn three questions that highlight important issues to think through for almost any data analysis. Second, we will discuss simple ways of visualizing patterns in data. Finally, we will go over the structure of datasets, including key terminology that is used to talk about data.
...
### Careful thought is required to evaluate graphs {#sec-critically-evaluating-graphs}
...
![A tiny difference that looks large: Comparing average male and female responses to survey item "I feel encouraged to come up with new and better ways of doing things."](Images/getting-started/zoomedin.png){#fig-gender-compare-zoomed-in alt="A tiny difference that looks large: Comparing average male and female responses to survey item \"I feel encouraged to come up with new and better ways of doing things.\"" width="400"}
...
![A tiny difference that looks tiny: Comparing average male and female responses to survey item "I feel encouraged to come up with new and better ways of doing things."](Images/getting-started/zoomedout.png){#fig-gender-compare-zoomed-out alt="A tiny difference that looks tiny: Comparing average male and female responses to survey item \"I feel encouraged to come up with new and better ways of doing things.\"" width="400"}
...
![A depiction of the trend in MMR vaccination among children starting primary school (kindergarten), compared to 95% target](Images/getting-started/vaccination2.png){#fig-vaccines-zoomed-out alt="A depiction of the trend in MMR vaccination among children starting primary school (kindergarten), compared to 95% target" width="400"}
...
![Another depiction of the trend in MMR vaccination among children starting primary school (kindergarten), compared to 95% target](Images/getting-started/vaccination1.png){#fig-vaccines-zoomed-in alt="Another depiction of the trend in MMR vaccination among children starting primary school (kindergarten), compared to 95% target" width="400"}
:::
...
### Three best practices for simple graphs
