...
2.  **Who (or what) is in the dataset?**
    ...
    ![Trend in 9-year-old math proficiency](Images/getting-started/9yo_naep.png){#fig-naep-9yr width="550"}

    [![Trend in 13-year-old math proficiency](Images/getting-started/13yo_naep.png){#fig-naep-13yr width="550"}](https://www.nationsreportcard.gov/ltt)
...
: Preview of a dataset of countries and their characteristics[^getting-started-7] {#tbl-country-preview}
...
: Preview of data from a 2024 survey of U.S. government employees[^getting-started-8] {#tbl-fevs-preview}
...
For qualitative and ordinal variables, we often use bar charts to depict the frequencies of different values. (We can also sometimes use bar charts to depict quantitative variables if all values are whole numbers, as we will see in @fig-quiz-1.)
...
Public health officials advise that at least 95% of the community should be vaccinated against measles in order to maintain herd immunity.[^getting-started-11] @fig-vaccines-zoomed-out shows estimates for the rate of measles-mumps-rubella (MMR) vaccination in the U.S. among children starting primary school (solid line).[^getting-started-12] The y-axis is drawn to start at 0, and the target rate of 95% is depicted as a dashed line. The solid line looks almost flat and is always close to the dashed line. It is hard to say much more based on this graph, except that the actual vaccination rate appears to fall a bit shy of the 95% target in recent years.
