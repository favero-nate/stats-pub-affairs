...
![Estimating two regressions separately by subsample](Images/regression/sample_split_reg.png){#fig-sample-split-reg width="350"}
...
![Visualization of a moderating relationship, estimated with an interaction term](Images/regression/interaction_reg.png){#fig-interaction-reg width="350"}
